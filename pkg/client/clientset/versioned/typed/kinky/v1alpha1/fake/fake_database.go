...
var databasesResource = schema.GroupVersionResource{Group: "kinky", Version: "v1alpha1", Resource: "databases"}

var databasesKind = schema.GroupVersionKind{Group: "kinky", Version: "v1alpha1", Kind: "Database"}
